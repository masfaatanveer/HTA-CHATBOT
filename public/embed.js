...
"  #hta-chat-frame { width: 400px !important; height: 630px !important; }" +(function () {
  "use strict";
...
// Mobile responsive
"@media screen and (max-width: 1024px) {" +
"  #hta-chat-frame { width: 400px !important; height: 630px !important; }" +
"  #hta-chat-trigger { width: 64px !important; height: 64px !important; }" +
"}" +
"@media screen and (max-width: 768px) {" +
"  #hta-chat-frame { width: 380px !important; height: 620px !important; bottom: 90px !important; right: 20px !important; }" +
"  #hta-chat-trigger { width: 56px !important; height: 56px !important; bottom: 20px !important; right: 20px !important; }" +
"}" +
"@media screen and (max-width: 600px) {" +
"  #hta-chat-frame { width: 92vw !important; height: 85vh !important; bottom: 14px !important; right: 14px !important; border-radius: 28px !important; }" +
"  #hta-chat-trigger { width: 54px !important; height: 54px !important; bottom: 18px !important; right: 18px !important; }" +
"  #hta-chat-trigger img { width: 36px !important; height: 36px !important; }" +
"}" +
"@media screen and (max-width: 420px) {" +
"  #hta-chat-frame { width: 94vw !important; height: 88vh !important; right: 10px !important; bottom: 10px !important; }" +
"  #hta-chat-trigger { width: 50px !important; height: 50px !important; right: 14px !important; }" +
"}";
